...
#define PULP2_ALL_SLEEP
// #define PULP2_SLAVE_SLEEP
// #define PULP2_BAR_PULP2_BAR_POLLING

#if defined(PULP2_ALL_SLEEP)
#   include "all_sleep.h"

#elif defined (PULP2_SLAVE_SLEEP)
#include "sl_sleep.h"

#elif defined (PULP2_BAR_POLLING)
#include "polling.h"
#endif
...
#ifdef PULP2_BAR_POLLING
    while(g == *exit);
#else  
    wait_event(myid+GP0,myid);
    clear_buff(myid);
#endif
